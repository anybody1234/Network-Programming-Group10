...
def main():
    try:
        ...
        create_room_payload = {
            "type": "CREATE_ROOM",
            "room_name": "Phong Thi Python Demo",
            "num_questions": 10,           # Số câu hỏi (Phải <= tổng số câu trong DB)
            "duration": 45,               # Thời gian (phút)
            "start_time": "2025-12-14 09:46:00" # Thời gian bắt đầu
        }
        
        send_json(s, create_room_payload)
